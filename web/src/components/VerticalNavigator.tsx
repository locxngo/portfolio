...
export default function VerticalNavigator() {
    const { currentSlide, totalSlides, goToSlide, currentLabel } = useNavigation();

    // If totalSlides is 1, return null to hide navigation
    if (totalSlides <= 1) return null;
    console.log("Rendering VerticalNavigator with currentSlide:", currentSlide, "totalSlides:", totalSlides, "currentLabel:", currentLabel);
    return (
        <aside className="fixed top-1/2 -translate-y-1/2 hidden lg:flex flex-col items-center gap-6 z-20 right-10">
            ...
            <div className="flex flex-col items-center gap-4">
                <div className="h-24 w-px bg-primary/10 mb-4"></div>
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] w-30 rotate-90 whitespace-nowrap origin-center translate-y-8 text-primary/40">
